...
/***/ "./src/assets/scripts/about/accordeon.js":
/*!***********************************************!*\
  !*** ./src/assets/scripts/about/accordeon.js ***!
  \***********************************************/
/***/ (function() {

eval("document.addEventListener('DOMContentLoaded', () => {\n  const faqItems = document.querySelectorAll('.about-faq');\n  faqItems.forEach(item => {\n    const header = item.querySelector('.about-faq-header');\n    header.addEventListener('click', () => {\n      const isActive = item.classList.contains('active');\n      faqItems.forEach(i => i.classList.remove('active'));\n      if (!isActive) {\n        item.classList.add('active');\n      }\n    });\n  });\n});\n\n//# sourceURL=webpack://build/./src/assets/scripts/about/accordeon.js?");
...
/******/ 	var __webpack_exports__ = __webpack_require__("./src/assets/scripts/about.js");
/******/ 	
/******/ })()
;